...
**Legendary Action Uses:** 3 (4 in Lair). Immediately after another creature's turn, the adult black dragon can expend a use to take one of the following actions. The adult black dragon regains all expended uses at the start of each of its turns.
