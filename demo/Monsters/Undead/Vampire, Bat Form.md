...
**Legendary Action Uses:** 3 (4 in Lair). Immediately after another creature's turn, the vampire, bat form can expend a use to take one of the following actions. The vampire, bat form regains all expended uses at the start of each of its turns.
